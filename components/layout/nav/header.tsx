...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header className='bg-scheme-2-background fixed top-0 z-50 w-full' onMouseLeave={() => setMegaMenuOpen(false)}>
        <nav>
              ...
              <div className='max-w-[1440px] mx-auto px-6 md:px-16 lg:px-16 py-8'>
                <div className='grid grid-cols-4 gap-8'>
                  {megaMenu.map((item, index) => (
                    <AutoLink key={index} href={item?.href || '#'} className='flex gap-3 py-2 group' onClick={() => setMegaMenuOpen(false)}>
                      {item?.icon && (
