      ...
      faqs: [
        {
          ...
          answer:
            "You'll master .NET, Angular, Entity Framework Core, and SQL Server. Our curriculum covers modern full-stack development technologies used by top tech companies.",
        },
        {
          question: 'Do I need prior coding experience?',
          answer:
            'Basic programming knowledge is helpful but not required. We accept motivated learners with varying technical backgrounds through our entry assessment.',
        },
        {
